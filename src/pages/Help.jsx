...
const Help = () => {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-8 bg-gradient-to-b from-slate-50 to-white min-h-screen font-inter antialiased text-gray-800 mt-10">
      {/* Search card */}
      <section className="bg-white rounded-2xl shadow-md p-6 mb-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-full md:w-96 px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-300"
              />
              <button
                id="search-btn"
        ...
        <div className="mt-4 text-xs text-gray-500">
          ...
          <span className="italic">reschedule</span>,{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <aside className="md:col-span-1 sticky top-6 self-start">
          <nav className="bg-white p-4 rounded-xl shadow-sm space-y-2 mt-10">
                ...
                <li key={item}>
                  <a
                    href={`#${item
                      ...
                      .replace(/ & | /g, "-")
                      .replace(/[^a-z-]/g, "")}`}
                    className="block px-3 py-2 rounded-md hover:bg-teal-50"
                  >
                    {item}
                  </a>
                </li>
          ...
          <div className="mt-4 bg-white p-4 rounded-xl shadow-sm text-sm">
            ...
            <ul className="mt-2 space-y-2 text-gray-600">
              ...
              <li>
                <a href="#video">Join video consultation</a>
              </li>
              <li>
                <a href="#troubleshoot">Video/audio issues</a>
              </li>
            </ul>
          </div>
        </aside>
